    ...
    post.sections.forEach(section => {
        ...
        switch (section.type) {
            ...
            case "file":
                ...
                const fileButton = buildButton("/icons/view.svg", titleFallback, () => window.open(`https://storage.liscitransmitter.de/transmitterstorage/${section.content}`, '_blank'));
...
function buildFooter(post) {
    ...
    const likeButton = buildLikeButton("/internal/likePost", post._id, post.liked, post.likes.length);
